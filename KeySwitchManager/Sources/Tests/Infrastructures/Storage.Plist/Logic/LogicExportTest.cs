...
namespace KeySwitchManager.Testing.Storage.Plist.Logic
{
    [TestFixture]
    public class LogicExportTest
    {
        private static readonly string TestDirectory = TestContext.CurrentContext.TestDirectory;
        private static readonly string TestOutputDirectory = Path.Combine( TestDirectory, $"{nameof( LogicExportTest )}_Output" );
        ...
        public void ExportTest()
        {
            ...
            var contentWriterFactory = new LogicExportContentFileWriterFactory( new DirectoryPath( outputDirectory ) );
            var exportContentFactory = new LogicExportContentFactory();
        ...
        public void ExportZipTest()
        {
            ...
            var contentWriterFactory = new ZipExportContentFileWriterFactory( zipArchive, ".plist" );
            var exportContentFactory = new LogicExportContentFactory();
