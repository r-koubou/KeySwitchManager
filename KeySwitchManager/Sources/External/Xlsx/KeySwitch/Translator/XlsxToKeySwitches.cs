...
using KeySwitchManager.Xlsx.KeySwitch.Model;

using RkHelper.Time;

namespace KeySwitchManager.Xlsx.KeySwitch.Translator
{
    public class XlsxToKeySwitches : IDataTranslator<Workbook, IReadOnlyCollection<Domain.KeySwitches.KeySwitch>>
    {
        ...
        public IReadOnlyCollection<Domain.KeySwitches.KeySwitch> Translate( Workbook source )
        {
        ...
        private Domain.KeySwitches.KeySwitch TranslateWorkSheet( Worksheet sheet, ICollection<Guid> parsedGuidList )
        {
