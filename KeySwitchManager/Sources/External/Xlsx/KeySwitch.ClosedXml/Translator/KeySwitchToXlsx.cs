...
{
    public class KeySwitchToXlsx : IDataTranslator<IReadOnlyCollection<Domain.KeySwitches.KeySwitch>, XLWorkbook>
    {
        ...
        public XLWorkbook Translate( IReadOnlyCollection<Domain.KeySwitches.KeySwitch> keySwitches )
        {
        ...
        #region Translation
        private static void TranslateWorkSheet( Domain.KeySwitches.KeySwitch keySwitch, XLWorkbook book )
        {
        ...
        private static int TranslateArticulation( Domain.KeySwitches.KeySwitch keySwitch, Articulation articulation, IXLWorksheet sheet, int row )
        {
            // Articulation name
            var column = SpreadsheetConstants.ColumnDataBegin;
