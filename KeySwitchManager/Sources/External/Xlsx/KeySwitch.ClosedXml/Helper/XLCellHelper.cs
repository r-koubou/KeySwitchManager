...
namespace KeySwitchManager.Xlsx.KeySwitch.ClosedXml.Helper
{
    ...
    internal static class XLCellHelper
    {
        ...
        public static void SetDefaultCellStyle( IXLWorksheet sheet, Domain.KeySwitches.KeySwitch template, int rowCount = 100 )
        {
